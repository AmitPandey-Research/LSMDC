...
def parse_opt():
    ...
    parser.add_argument('--track', action='store_true', help='use w&b tracking setup.')

    # Enable OverFitting Run

    parser.add_argument('--overfit', action='store_true', help='trigger overfit run.')
    ...
    parser.add_argument('--nvid', type=int, default=5,
                        help='no. of videos given as input')
    parser.add_argument('--model_dim', type=int, default=512,
                    help='Model dimension being used')
    parser.add_argument('--model_type', type=str, default="transfomer",
                    help='Model type')
    parser.add_argument('--nhead', type=int, default=4,
                    help='No.of heads in the transformer encoder layer')
    parser.add_argument('--dropout_p', type=float, default=0.2,
                    help='Dropout probability')
    parser.add_argument('--d_hid', type=int, default=512,
                    help='Dimenion of the hidden layer of the transformer encoder')
    parser.add_argument('--nsegments', type=int, default=5,
                    help='No.of the segments the video is divided into.')
    parser.add_argument('--nlayers', type=int, default=2,
                    help='No.of layers of the transformer encoder')
